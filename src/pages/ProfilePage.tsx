          ...
          <div className="flex items-center gap-1.5 mt-[2px]">
            ...
            {spotify && (
              <>
                ...
                <span className="text-[11px] text-[#1DB954] truncate">{song}{artist ? ` — ${artist}` : ""}</span>
              </>
            )}
          </div>
        </div>
      ...
      {spotify && total > 0 && (
        <div className="px-3 pb-3 -mt-1">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[9px] text-[#52525b] tabular-nums shrink-0">{formatTime(elapsed)} / {formatTime(total)}</span>
          </div>
        </div>
      )}
    </div>
